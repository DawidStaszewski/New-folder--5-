<template>
    <div class="p-8 bg-gray-900 text-white min-h-screen">
        ...
        <div class="bg-gray-800 p-4 rounded-lg shadow-lg mb-6">
            ...
            <div class="flex flex-wrap justify-start gap-4">
                <div class="w-64">
                    ...
                    <select id="category" v-model="selectedCategory" @change="fetchJobOffersByCategory"
                ...
                <div class="w-64">
                    ...
                    <input id="searchText" v-model="searchText" type="text"
        ...
        <div v-else-if="filteredJobOffers.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div v-for="offer in filteredJobOffers" :key="offer.id"
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4 flex items-center">
                        ...
                        <span v-if="offer.employer.verified === '1'" class="ml-2 text-sm text-green-400 font-bold">
                            (Zweryfikowany)
                        </span>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span v-for="competence in offer.competences" :key="competence.id"
                ...
                <div class="p-4 bg-gray-700 flex items-center justify-between">
                    ...
                    <button @click="viewJobOffer(offer)"
...
export default {
    ...
    methods: {
        viewJobOffer(offer) {
            this.$router.push({ name: "JobOfferDetailsEmployer", params: { id: offer.id } });
        },
